...
local skills = {
  { name = "Attack Speed", data = {}, id = 0, enabled = true},
  { name = "Club", data = {}, id = 1, enabled = false },
  { name = "Sword", data = {}, id = 2, enabled = true },
  { name = "Glove", data = {}, id = 3, enabled = true },
  ...
  { name = "Level",  data = {}, id = 13, enabled = true },
  { name = "Magic Level", data = {}, id = 14, enabled = true },
...
function checkStamina()
  ...
  if skill and skill.enabled then
    ...
    label:setColoredText({
      '~ '..skill.name..': ', (skill.color or 'yellow'),
